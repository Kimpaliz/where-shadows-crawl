/* [Aufgabe: Prüfwesen] Die Kartenhand: Katalog, Seltenheit, Meta-Regeln.
   ...
   `runtime/schrift.js` (kann sie gemalt werden). Die **Hand** — Ort,
   Klick und Bild — steht in `werkzeuge/pruefe-kartenhand.mjs`: Beide
   zusammen rissen die Zeilengrenze, und der Schnitt folgt dem Thema. */
