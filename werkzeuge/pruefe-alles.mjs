/* [Aufgabe: Prüfwesen] Alle Prüfungen, plus die Syntaxprüfung jeder Datei.
   ...
   | `pruefe-vorgaenge.mjs` | jede Phase und jeder Schritt hat einen Vorgang, keine Nummer doppelt, und der Schritte-Block eines Sammelvorgangs entsteht genau einmal | die Vorgangsnummer, die beim Umschreiben der Roadmap unter die falsche Phase gerutscht ist — und die Aufgabenliste, die nach dem ersten Haken ein zweites Mal angehängt wird |
   ...
   | `pruefe-sichtbarkeit.mjs` | der Vermerk „nicht in Suchmaschinen aufnehmen" steht im Kopf von `index.html`, und keine `robots.txt` macht ihn unlesbar | die eine Zeile, die beim nächsten Umbau des Kopfbereichs verschwindet — bemerkt erst Monate später, wenn die Seite in einer Trefferliste auftaucht und der Vorhang seit Wochen offen steht |
